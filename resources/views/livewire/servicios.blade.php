    ...
    <div class="w-full max-w-7xl">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
            ...
            <div class="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center">
                <img src="{{ asset('images/insumos.png') }}" alt="Insumos Agrícolas" class="w-40 h-28 mb-5">
            ...
            <!-- Servicio 2 -->
            <div class="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center">
                <img src="{{ asset('images/herramientas.png') }}" alt="Herramientas" class="w-40 h-28 mb-5">
            ...
            <!-- Servicio 3 -->
            <div class="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center">
                <img src="{{ asset('images/abonos.png') }}" alt="Abonos" class="w-40 h-32 mb-5">
            ...
            <!-- Servicio 4 -->
            <div class="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center">
                <img src="{{ asset('images/asesoria.png') }}" alt="Asesoría Técnica" class="w-40 h-28 mb-5">
            ...
            <!-- Servicio 5 -->
            <div class="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center">
                <img src="{{ asset('images/semillass.png') }}" alt="Semillas Certificadas" class="w-40 h-28 mb-5">
            ...
            <!-- Servicio 6 -->
            <div class="bg-white rounded-xl shadow-lg p-8 flex flex-col items-center">
                <img src="{{ asset('images/distribucion.png') }}" alt="Distribución" class="w-45 h-42 mb-5">
